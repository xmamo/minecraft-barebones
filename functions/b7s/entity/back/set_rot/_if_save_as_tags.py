...
for exponent in range(7, -1, -1):
	print('scoreboard players tag @s[score_b7s:_tmp_min={}] add b7s:back_rot_x_{}'.format(2 ** exponent, exponent))
	if exponent != 0:
...
for exponent in range(8, -1, -1):
	print('scoreboard players tag @s[score_b7s:_tmp_min={}] add b7s:back_rot_y_{}'.format(2 ** exponent, exponent))
	if exponent != 0:
		print('scoreboard players remove @s[score_b7s:_tmp_min={0}] b7s:_tmp {0}'.format(2 ** exponent))

print()
print('scoreboard players tag @s add b7s:back_rot_tags_set')
