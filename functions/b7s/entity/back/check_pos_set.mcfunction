...
# Checks whether the back position has been set for a specific entity.
#
# Tags set:
# b7s:back_pos_set — if the back position was set
#
# Usage:
# /execute <entity> ~ ~ ~ function b7s:entity/back/check_pos_set
