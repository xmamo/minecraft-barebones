...
print('# Tags set:')
print('#                                                      25')
print('# b7s:x_0, …, b7s:x_25 — such that b7s:x = -30000000 + ∑ b7s:x_i × 2^i')
print('#                                                      i=0')
print('#                                                  12')
print('# b7s:y_0, …, b7s:y_12 — such that b7s:y = -4096 + ∑ b7s:y_i × 2^i')
print('#                                                  i=0')
print('#                                                      25')
print('# b7s:z_0, …, b7s:z_25 — such that b7s:z = -30000000 + ∑ b7s:z_i × 2^i')
print('#                                                      i=0')
print('#')
print('# Usage:')
