...
scoreboard players reset @s b7s:spawn_pos_x
scoreboard players reset @s b7s:spawn_pos_y
scoreboard players reset @s b7s:spawn_pos_z
...
scoreboard players tag @s[score_b7s:spawn_pos_x_min=-2147483648,score_b7s:spawn_pos_y_min=-2147483648,score_b7s:spawn_pos_z_min=-2147483648] add b7s:spawn_pos_set
