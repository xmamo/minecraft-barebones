...
scoreboard players test b7s:config b7s:home_as_tags -2147483648
...
scoreboard players test b7s:config b7s:back_as_tags -2147483648
...
scoreboard players test b7s:config b7s:persist_back -2147483648
