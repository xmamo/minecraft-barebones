...
for exponent in range(7, -1, -1):
	print('scoreboard players add @s[tag=b7s:back_rot_x_{}] b7s:rot_x {}'.format(exponent, 2 ** exponent))

print()
for exponent in range(8, -1, -1):
	print('scoreboard players add @s[tag=b7s:back_rot_y_{}] b7s:rot_y {}'.format(exponent, 2 ** exponent))
