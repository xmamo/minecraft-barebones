...
for exponent in range(25, -1, -1):
	print('scoreboard players add @s[tag=b7s:home_x_{}] b7s:x {}'.format(exponent, 2 ** exponent))

print()
for exponent in range(12, -1, -1):
	print('scoreboard players add @s[tag=b7s:home_y_{}] b7s:y {}'.format(exponent, 2 ** exponent))

print()
for exponent in range(25, -1, -1):
	print('scoreboard players add @s[tag=b7s:home_z_{}] b7s:z {}'.format(exponent, 2 ** exponent))
