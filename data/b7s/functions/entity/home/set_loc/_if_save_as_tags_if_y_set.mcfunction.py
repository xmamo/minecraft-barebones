...
for i in range(32):
	print('tag @s add b7s.home_y_{}'.format(i))
print()

print('scoreboard players operation @s b7s._tmp_1 = @s b7s.y')
print('tag @s[scores={b7s._tmp_1=..-1}] remove b7s.home_y_31')
print('scoreboard players add @s[tag=!b7s.home_y_31] b7s._tmp_1 1073741824')
print('scoreboard players add @s[tag=!b7s.home_y_31] b7s._tmp_1 1073741824')
...
for i in range(31):
	...
	print('tag @s[scores={{b7s._tmp_3=0}}] remove b7s.home_y_{}'.format(i))
	if i != 30:
		print('scoreboard players operation @s b7s._tmp_1 /= @s b7s._tmp_2')
print()

print('tag @s add b7s.home_y_set')
